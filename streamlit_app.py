...
ANSWERS_LOOKUP = {
    "q01": "According to the Leave Policy (02_Leave_Policy.pdf), Earned Leave accrues at the rate of 1.25 days per month. Employees become eligible for 15 days of Earned Leave upon completion of one year of continuous service, provided they have worked for a minimum of 240 days in that year.",
    ...
    "q03": "According to the Leave Policy (02_Leave_Policy.pdf), female employees who have completed a minimum of 80 days of service in the 12 months preceding the expected date of delivery are entitled to 26 weeks of paid Maternity Leave for the first two live births, and 12 weeks for a third child.",
    ...
    "q05": "According to the Compensation and Benefits Policy (06_Compensation_and_Benefits_Policy.pdf), salaries and professional fees are processed and credited to the employee's registered bank account by the 7th of the following month. The payroll cut-off date is the 24th of each month.",
    
    "q06": "According to the Compensation and Benefits Policy (06_Compensation_and_Benefits_Policy.pdf), the CTC range for an L4 (Senior) grade employee is Rs. 16.0L to Rs. 26.0L per annum, and the performance bonus target is 10% of CTC.",
    ...
    "q09": "According to the Performance Review Policy (05_Performance_Review_Policy.pdf), the Annual Performance Review (APR) timeline is: 360 degree feedback collected (1 to 20 February), employee self-assessment submitted (1 to 10 March), manager completes assessment (11 to 20 March), calibration meeting held (21 to 25 March), final ratings locked and confirmed (26 to 31 March), one-on-one feedback conversation (1 to 10 April), and increment and promotion letters are issued on 15 April.",
    
    "q10": "According to the Work From Home Policy (03_Work_From_Home_Policy.pdf), permanent employees at grade L3 and above are eligible for WFH arrangements if they have completed a minimum of 6 months of continuous service, received a performance rating of Meets Expectations or above, have no active PIP, and have a suitable role and a reliable internet connection. Employees on probation, at grades L1 and L2, and deployed at client sites are not eligible unless approved in writing by the HR Director. The available arrangements are Hybrid WFH (up to 3 days/week), Full Remote (up to 5 days/week), Ad-hoc WFH (up to 2 days/week), and Emergency WFH.",
