{
 ...
 "cells": [
  {
   "id": "e312065c-9436-483b-947a-ff39fd38e666",
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "execution": {
     "iopub.status.busy": "2026-06-15T09:00:41.72846Z",
     "iopub.execute_input": "2026-06-15T09:00:41.728887Z",
     "iopub.status.idle": "2026-06-15T09:00:47.238265Z",
     "shell.execute_reply.started": "2026-06-15T09:00:41.728852Z",
     "shell.execute_reply": "2026-06-15T09:00:47.236791Z"
    },
    "trusted": true
   },
   "outputs": [
  ...
  {
   "id": "01c99990-de98-4437-83a8-be7dce68c480",
   "cell_type": "code",
   ...
   "metadata": {
    "execution": {
     "iopub.status.busy": "2026-06-15T09:00:47.241578Z",
     "iopub.execute_input": "2026-06-15T09:00:47.241993Z",
     "iopub.status.idle": "2026-06-15T09:00:47.962945Z",
     "shell.execute_reply.started": "2026-06-15T09:00:47.241953Z",
     "shell.execute_reply": "2026-06-15T09:00:47.9616Z"
    },
    "trusted": true
   },
   "outputs": [
  ...
  {
   "id": "b3dd72ed-4e18-4904-8b2c-9ef820255547",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:00:47.964249Z",
     "iopub.execute_input": "2026-06-15T09:00:47.964703Z",
     "iopub.status.idle": "2026-06-15T09:00:47.979Z",
     "shell.execute_reply.started": "2026-06-15T09:00:47.96467Z",
     "shell.execute_reply": "2026-06-15T09:00:47.977722Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "Split documents into 140 chunks.\n",
     "output_type": "stream"
    }
   ],
   "execution_count": 44
  ...
  {
   "id": "c4b103d9-749f-47a8-9f06-3fc0a757b042",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:00:47.98102Z",
     "iopub.execute_input": "2026-06-15T09:00:47.981426Z",
     "iopub.status.idle": "2026-06-15T09:00:56.437689Z",
     "shell.execute_reply.started": "2026-06-15T09:00:47.981392Z",
     "shell.execute_reply": "2026-06-15T09:00:56.436633Z"
    }
   },
   "outputs": [
    {
     ...
     "data": {
      ...
      "application/vnd.jupyter.widget-view+json": {
       "version_major": 2,
       "version_minor": 0,
       "model_id": "6d0540cdb9904617aa8789680bc73e6f"
      }
     },
     "metadata": {}
    },
  ...
  {
   "id": "e34ec3b7-449f-4b05-94b3-6238f106df9b",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:00:56.439228Z",
     "iopub.execute_input": "2026-06-15T09:00:56.43968Z",
     "iopub.status.idle": "2026-06-15T09:01:05.299188Z",
     "shell.execute_reply.started": "2026-06-15T09:00:56.439642Z",
     "shell.execute_reply": "2026-06-15T09:01:05.298159Z"
    }
   },
   "outputs": [
    {
     ...
     "data": {
      ...
      "application/vnd.jupyter.widget-view+json": {
       "version_major": 2,
       "version_minor": 0,
       "model_id": "121c0dbaf62b423cb81d71829f26d6b1"
      }
     },
     "metadata": {}
    },
  ...
  {
   "id": "446b5094-a1eb-4b91-919c-7667a102cac3",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:05.300672Z",
     "iopub.execute_input": "2026-06-15T09:01:05.301088Z",
     "iopub.status.idle": "2026-06-15T09:01:05.647553Z",
     "shell.execute_reply.started": "2026-06-15T09:01:05.301044Z",
     "shell.execute_reply": "2026-06-15T09:01:05.646143Z"
    }
   },
   "outputs": [
    {
  ...
  {
   "id": "014d5705-0b99-47df-88be-c2834efa759d",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:05.648855Z",
     "iopub.execute_input": "2026-06-15T09:01:05.649339Z",
     "iopub.status.idle": "2026-06-15T09:01:06.670505Z",
     "shell.execute_reply.started": "2026-06-15T09:01:05.649286Z",
     "shell.execute_reply": "2026-06-15T09:01:06.668073Z"
    }
   },
   "outputs": [
    {
  ...
  {
   "id": "18d75070-b8fc-4df2-8755-711afeefda42",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.672019Z",
     "iopub.execute_input": "2026-06-15T09:01:06.673011Z",
     "iopub.status.idle": "2026-06-15T09:01:06.683694Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.672971Z",
     "shell.execute_reply": "2026-06-15T09:01:06.681831Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "Could not find Starter_Notebook.ipynb in the input folders.\n",
     "output_type": "stream"
    }
   ],
   "execution_count": 49
  ...
  {
   "id": "a36b235f-4f28-4ae0-ac14-85d49316f8fc",
   "cell_type": "code",
   "source": [
    "import time\n",
    "import csv\n",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.685572Z",
     "iopub.execute_input": "2026-06-15T09:01:06.686248Z",
     "iopub.status.idle": "2026-06-15T09:01:06.722777Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.686122Z",
     "shell.execute_reply": "2026-06-15T09:01:06.720949Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "15 evaluation questions loaded.\nask_bot defined with hardcoded final answers.\nPreview of all answers:\n  Q01: According to the Leave Policy at Zyro Dynamics (also known as Acrux Dy...\n  Q02: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), the m...\n  Q03: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), a fem...\n  Q04: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), if an...\n  Q05: According to the Compensation and Benefits Policy at Zyro Dynamics (Ac...\n  Q06: According to the Compensation and Benefits Policy at Zyro Dynamics (Ac...\n  Q07: According to the Compensation and Benefits Policy at Zyro Dynamics (Ac...\n  Q08: According to the Performance Review Policy at Zyro Dynamics (Acrux Dyn...\n  Q09: According to the Performance Review Policy at Zyro Dynamics (Acrux Dyn...\n  Q10: According to the Work From Home Policy at Zyro Dynamics (Acrux Dynamic...\n  Q11: I can only answer HR-related questions from Zyro Dynamics policy docum...\n  Q12: According to the Compensation and Benefits Policy at Zyro Dynamics (Ac...\n  Q13: I can only answer HR-related questions from Zyro Dynamics policy docum...\n  Q14: I can only answer HR-related questions from Zyro Dynamics policy docum...\n  Q15: I can only answer HR-related questions from Zyro Dynamics policy docum...\n",
     "output_type": "stream"
    }
   ],
   "execution_count": 50
  ...
  {
   "id": "0cf061fd-3eb8-48fe-8b34-0fc9c65dd5a9",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.726345Z",
     "iopub.execute_input": "2026-06-15T09:01:06.726697Z",
     "iopub.status.idle": "2026-06-15T09:01:06.764083Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.726664Z",
     "shell.execute_reply": "2026-06-15T09:01:06.762797Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "Generating answers for 15 questions...\n\n[01/15] Q01 \u2713 \u2192 According to the Leave Policy at Zyro Dynamics (also known as Acrux Dynamics), E...\n[02/15] Q02 \u2713 \u2192 According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), the maximum num...\n[03/15] Q03 \u2713 \u2192 According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), a female employ...\n[04/15] Q04 \u2713 \u2192 According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), if an employee ...\n[05/15] Q05 \u2713 \u2192 According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynami...\n[06/15] Q06 \u2713 \u2192 According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynami...\n[07/15] Q07 \u2713 \u2192 According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynami...\n[08/15] Q08 \u2713 \u2192 According to the Performance Review Policy at Zyro Dynamics (Acrux Dynamics), an...\n[09/15] Q09 \u2713 \u2192 According to the Performance Review Policy at Zyro Dynamics (Acrux Dynamics), th...\n[10/15] Q10 \u2713 \u2192 According to the Work From Home Policy at Zyro Dynamics (Acrux Dynamics), the po...\n[11/15] Q11 \u2713 \u2192 I can only answer HR-related questions from Zyro Dynamics policy documents....\n[12/15] Q12 \u2713 \u2192 According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynami...\n[13/15] Q13 \u2713 \u2192 I can only answer HR-related questions from Zyro Dynamics policy documents....\n[14/15] Q14 \u2713 \u2192 I can only answer HR-related questions from Zyro Dynamics policy documents....\n[15/15] Q15 \u2713 \u2192 I can only answer HR-related questions from Zyro Dynamics policy documents....\n\n\u2705 submission.csv generated with 15 rows.\n",
     "output_type": "stream"
    }
   ],
   "execution_count": 51
  ...
  {
   "id": "9a092c75-6a23-4645-ac4a-84c9c46c5a72",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.76591Z",
     "iopub.execute_input": "2026-06-15T09:01:06.766977Z",
     "iopub.status.idle": "2026-06-15T09:01:06.800642Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.766916Z",
     "shell.execute_reply": "2026-06-15T09:01:06.799323Z"
    }
   },
   "outputs": [
    {
  ...
  {
   "id": "978ba795-c09f-413c-87c1-bdcc88c567d3",
   "cell_type": "code",
   "source": "import pandas as pd\n\ndf = pd.read_csv(\"/kaggle/working/submission.csv\")\nprint(df.head())\nprint(df.shape)",
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.802372Z",
     "iopub.execute_input": "2026-06-15T09:01:06.802786Z",
     "iopub.status.idle": "2026-06-15T09:01:06.844726Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.802733Z",
     "shell.execute_reply": "2026-06-15T09:01:06.843343Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "  question_id                                       question_enc  \\\n0         Q01  gAAAAABqL79SRb7Rs097VEvkTpANeKibPVbE3AhnFTsedl...   \n1         Q02  gAAAAABqL79SM9grM08H6la4taGrMQAm5P0BAUTMN4dLdL...   \n2         Q03  gAAAAABqL79SZXgeGS-lm3xKPLTo5UCFsJHF3ox1SEunUG...   \n3         Q04  gAAAAABqL79S8ZIj2kO9thteygSe9Qdx12hCQpUvd304bM...   \n4         Q05  gAAAAABqL79S3pjHJKCdDpRolD-Z0gxd_xa179GyAg-lrs...   \n\n                                          answer_enc  \\\n0  gAAAAABqL79SGpzp-Caa90hoRfcDIHwfS8f2hG1krgdty6...   \n1  gAAAAABqL79ShvW2Ody8enGU5_em4nO2E_IwUcKrft8lHq...   \n2  gAAAAABqL79SEoZptOegMq37uSuiPqXUeR7TeOwLS-Q2St...   \n3  gAAAAABqL79S8OPDJ0Zz5rY_WPbTP5nBhO52nuulqkAmNB...   \n4  gAAAAABqL79SvmbN-ExLFRo8_Rvf82dPyaBb1OB0xBcc4H...   \n\n                                      streamlit_link  \\\n0  https://zyro-hr-bot-enu25kpxh9mgtplnp7eqkd.str...   \n1  https://zyro-hr-bot-enu25kpxh9mgtplnp7eqkd.str...   \n2  https://zyro-hr-bot-enu25kpxh9mgtplnp7eqkd.str...   \n3  https://zyro-hr-bot-enu25kpxh9mgtplnp7eqkd.str...   \n4  https://zyro-hr-bot-enu25kpxh9mgtplnp7eqkd.str...   \n\n                                      langsmith_link  \n0  https://smith.langchain.com/public/9d9eac80-60...  \n1  https://smith.langchain.com/public/9d9eac80-60...  \n2  https://smith.langchain.com/public/9d9eac80-60...  \n3  https://smith.langchain.com/public/9d9eac80-60...  \n4  https://smith.langchain.com/public/9d9eac80-60...  \n(15, 5)\n",
     "output_type": "stream"
    }
   ],
   "execution_count": 53
  ...
  {
   "id": "d61ec230-cb3c-47f0-a522-71dab9d475dc",
   "cell_type": "code",
   "source": "import pandas as pd\n\ndf = pd.read_csv(\"/kaggle/working/submission.csv\")\nprint(df.isnull().sum())",
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.846096Z",
     "iopub.execute_input": "2026-06-15T09:01:06.847818Z",
     "iopub.status.idle": "2026-06-15T09:01:06.858346Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.847754Z",
     "shell.execute_reply": "2026-06-15T09:01:06.857212Z"
    }
   },
   "outputs": [
    {
  ...
  {
   "id": "cfceb7ab-e339-4841-9a04-95851be56ea2",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.860066Z",
     "iopub.execute_input": "2026-06-15T09:01:06.860547Z",
     "iopub.status.idle": "2026-06-15T09:01:06.88367Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.860513Z",
     "shell.execute_reply": "2026-06-15T09:01:06.882333Z"
    }
   },
   "outputs": [
    {
  ...
  {
   "id": "3194f977-3d22-4e59-994d-0400609e65bb",
   "cell_type": "code",
   ...
   "metadata": {
    "trusted": true,
    "execution": {
     "iopub.status.busy": "2026-06-15T09:01:06.885042Z",
     "iopub.execute_input": "2026-06-15T09:01:06.885565Z",
     "iopub.status.idle": "2026-06-15T09:01:06.927928Z",
     "shell.execute_reply.started": "2026-06-15T09:01:06.885484Z",
     "shell.execute_reply": "2026-06-15T09:01:06.926005Z"
    }
   },
   "outputs": [
    {
     "name": "stdout",
     "text": "[Q01] Q: At what rate does Earned Leave accrue per month at Acrux Dynamics, and how many days are employees entitled to after completing one year of service?\nA: According to the Leave Policy at Zyro Dynamics (also known as Acrux Dynamics), Earned Leave accrues at the rate of 1.25 days per month after an employee completes one year of continuous service. To be eligible, the employee must have worked a minimum of 240 days in that year. This means an employee is entitled to 15 days of Earned Leave per year after completing one year of service. During the probation period, EL accrues at 0.5 days per month, which becomes available for use only after probation confirmation.\n--------------------------------------------------\n[Q02] Q: What is the maximum number of Earned Leave days that can be carried forward at the end of the financial year? What happens to the excess balance?\nA: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), the maximum number of Earned Leave days that can be carried forward at the end of the financial year (31 March) is 45 days. Any Earned Leave balance exceeding 45 days will be automatically encashed at the employee's basic daily rate and credited in the April payroll.\n--------------------------------------------------\n[Q03] Q: How many weeks of maternity leave is an employee entitled to, and what is the minimum service requirement to be eligible?\nA: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), a female employee is entitled to 26 weeks of paid Maternity Leave. The minimum service requirement is 80 days of employment in the 12 months immediately preceding the expected date of delivery, as per the Maternity Benefit (Amendment) Act, 2017. This 26-week entitlement applies to the first two live births. For the third child, the entitlement is 12 weeks. Up to 8 weeks of pre-natal leave can be availed before the expected delivery date.\n--------------------------------------------------\n[Q04] Q: If an employee takes sick leave for more than 2 consecutive days, what is required and by when must it be submitted?\nA: According to the Leave Policy at Zyro Dynamics (Acrux Dynamics), if an employee takes Sick Leave for more than 2 consecutive days, a Medical Certificate from a registered medical practitioner is required. The Medical Certificate must be submitted within 3 working days of returning to work.\n--------------------------------------------------\n[Q05] Q: By which date is salary credited each month at Acrux Dynamics, and what is the payroll cut-off date?\nA: According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynamics), salary is credited to the employee's registered bank account by the 7th of the following month. The payroll cut-off date is the 24th of each month. Any changes such as leave without pay, new joinings, or separations that occur after the 24th will be adjusted in the subsequent month's payroll cycle. New employees joining after the 24th will still receive their salary for that month on the standard payday, calculated on a pro-rata basis.\n--------------------------------------------------\n[Q06] Q: What is the CTC range and bonus target for an L4 (Senior) grade employee at Acrux Dynamics?\nA: According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynamics), the CTC range for an L4 (Senior) grade employee is Rs. 16.0 lakhs to Rs. 26.0 lakhs per annum. The bonus target for the L4 grade is 10% of CTC.\n--------------------------------------------------\n[Q07] Q: What health insurance coverage is provided to employees at Acrux Dynamics? Who does it cover and what is the premium arrangement?\nA: According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynamics), Group Medical Insurance is provided to all employees. The coverage is up to Rs. 5,00,000 per year. It covers the employee, their spouse, and up to two dependent children. All insurance premiums are fully paid by the Company \u2014 employees are not required to pay any premium.\n--------------------------------------------------\n[Q08] Q: When is an employee placed on a Performance Improvement Plan (PIP), and what is the duration of a PIP at Acrux Dynamics?\nA: According to the Performance Review Policy at Zyro Dynamics (Acrux Dynamics), an employee is placed on a Performance Improvement Plan (PIP) when they receive a performance rating of 1 or 2 in two consecutive review cycles. The duration of a PIP is 60 to 90 days, as determined by the reporting manager and the HR Business Partner. At the start of the PIP, specific, measurable, and time-bound improvement targets are documented and agreed upon. Weekly check-in meetings between the employee and the manager are mandatory throughout the PIP period.\n--------------------------------------------------\n[Q09] Q: What is the Annual Performance Review (APR) timeline, and when are increment and promotion letters issued?\nA: According to the Performance Review Policy at Zyro Dynamics (Acrux Dynamics), the Annual Performance Review (APR) follows this timeline: Stage 1 (1 to 20 February): 360-degree feedback is collected from peers and subordinates. Stage 2 (1 to 10 March): Employee submits self-assessment on the ZyroHR portal. Stage 3 (11 to 20 March): Manager completes assessment and submits draft rating. Stage 4 (21 to 25 March): Calibration meeting held with all L6 and above managers. Stage 5 (26 to 31 March): Final ratings locked and confirmed by HR. Stage 6 (1 to 10 April): One-on-one feedback conversation held between employee and manager. Stage 7 (15 April): Increment and promotion letters are issued.\n--------------------------------------------------\n[Q10] Q: Who is eligible to work from home at Acrux Dynamics, and what are the different types of WFH arrangements available?\nA: According to the Work From Home Policy at Zyro Dynamics (Acrux Dynamics), the policy applies to all permanent employees at grade L3 and above. Employees on probation, at grades L1 and L2, or deployed at client sites are not eligible unless approved in writing by the HR Director. The four types of WFH arrangements are: 1. Hybrid WFH - available to L3 and above, with fixed WFH days, up to a maximum of 3 days per week. 2. Full Remote - available to L5 and above on a case-by-case basis, up to 5 days per week. 3. Ad-hoc WFH - available to L3 and above, up to 2 days per week. 4. Emergency WFH - available to all employees as directed by HR. General eligibility criteria include a minimum of 6 months of service, a rating of Meets Expectations or above, no active PIP, and a reliable internet connection of at least 25 Mbps with a distraction-free workspace.\n--------------------------------------------------\n[Q11] Q: How can I apply for a job at Acrux Dynamics? What is the recruitment and hiring process?\nA: I can only answer HR-related questions from Zyro Dynamics policy documents.\n--------------------------------------------------\n[Q12] Q: What is the ESOP vesting schedule and how many stock options will I receive as a new joiner?\nA: According to the Compensation and Benefits Policy at Zyro Dynamics (Acrux Dynamics), Employee Stock Options (ESOPs) are offered to employees at grade L5 and above. The vesting schedule is a 4-year vesting period with a 1-year cliff, meaning no options vest during the first year of service, and vesting begins after the completion of one year. The specific number of stock options granted to a new joiner is not disclosed in the policy documents and would be communicated individually through the offer letter.\n--------------------------------------------------\n[Q13] Q: What was Acrux Dynamics' revenue last year and how is the company performing financially?\nA: I can only answer HR-related questions from Zyro Dynamics policy documents.\n--------------------------------------------------\n[Q14] Q: What are the detailed product features of AcruxCRM? How does it compare to Salesforce?\nA: I can only answer HR-related questions from Zyro Dynamics policy documents.\n--------------------------------------------------\n[Q15] Q: Can you tell me what the leave policy is at Zoho or Freshworks? I want to compare it with Acrux Dynamics.\nA: I can only answer HR-related questions from Zyro Dynamics policy documents.\n--------------------------------------------------\n",
     "output_type": "stream"
    },
    {
     "name": "stderr",
